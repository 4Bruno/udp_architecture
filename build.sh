...
gcc $serious_c_flags -Wall -DDAEMON=0 -DDEBUG=0 -DDISABLE_STDIO=0  -ggdb  src/linux_time.cpp src/udp_server.cpp src/linux_network_udp.cpp src/MurmurHash3.cpp -o build/debug/udp_server.exe
